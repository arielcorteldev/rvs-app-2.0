...
################################################################################
## Form generated from reading UI file 'lcrsearchmarriagewindow.ui'
##
...
## verify.py uses the separate Verify_Marriage_Window.py, which no longer has
...
class Ui_LCRSearchMarriageWindow(object):
    def setupUi(self, LCRSearchMarriageWindow):
        if not LCRSearchMarriageWindow.objectName():
            LCRSearchMarriageWindow.setObjectName(u"LCRSearchMarriageWindow")
        LCRSearchMarriageWindow.resize(800, 600)
        icon = QIcon()
        icon.addFile(u"assets/icons/magnifier.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        LCRSearchMarriageWindow.setWindowIcon(icon)
        self.centralwidget = QWidget(LCRSearchMarriageWindow)
        ...
        LCRSearchMarriageWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(LCRSearchMarriageWindow)

        QMetaObject.connectSlotsByName(LCRSearchMarriageWindow)
    # setupUi

    def retranslateUi(self, LCRSearchMarriageWindow):
        LCRSearchMarriageWindow.setWindowTitle(QCoreApplication.translate("LCRSearchMarriageWindow", u"MainWindow", None))
        ...
        self.regyear_textEdit.setPlaceholderText(QCoreApplication.translate("LCRSearchMarriageWindow", u"Enter Reg Year/Book No.", None))
        self.everify_button.setText(QCoreApplication.translate("LCRSearchMarriageWindow", u"PushButton", None))
    # retranslateUi