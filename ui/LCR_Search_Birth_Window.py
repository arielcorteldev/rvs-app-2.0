...
################################################################################
## Form generated from reading UI file 'lcrsearchbirthwindow.ui'
##
...
## verify.py uses the separate Search_Birth_Window.py, which no longer has
...
class Ui_LCRSearchBirthWindow(object):
    def setupUi(self, LCRSearchBirthWindow):
        if not LCRSearchBirthWindow.objectName():
            LCRSearchBirthWindow.setObjectName(u"LCRSearchBirthWindow")
        LCRSearchBirthWindow.resize(800, 600)
        icon = QIcon()
        icon.addFile(u"assets/icons/magnifier.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        LCRSearchBirthWindow.setWindowIcon(icon)
        self.centralwidget = QWidget(LCRSearchBirthWindow)
        ...
        LCRSearchBirthWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(LCRSearchBirthWindow)

        QMetaObject.connectSlotsByName(LCRSearchBirthWindow)
    # setupUi

    def retranslateUi(self, LCRSearchBirthWindow):
        LCRSearchBirthWindow.setWindowTitle(QCoreApplication.translate("LCRSearchBirthWindow", u"MainWindow", None))
        ...
        self.regyear_textEdit.setPlaceholderText(QCoreApplication.translate("LCRSearchBirthWindow", u"Enter Reg Year/Book No.", None))
        self.everify_button.setText(QCoreApplication.translate("LCRSearchBirthWindow", u"PushButton", None))
    # retranslateUi