...
a = Analysis(
    ...
    datas=[('assets', 'assets'), ('controllers', 'controllers'), ('docs', 'docs'), ('flask_server', 'flask_server'), ('forms', 'forms'), ('html_forms', 'html_forms'), ('images', 'images'), ('templates', 'templates'), ('ui', 'ui'), ('utilities', 'utilities'), ('.env', '.'), ('everify_server.log', '.'), ('requirements.txt', '.')],
